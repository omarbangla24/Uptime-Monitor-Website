...
<div class="px-4 sm:px-6 lg:px-8 py-8">
    <div class="mx-auto">
        ...
        <form action="{{ route('admin.blogs.store') }}" method="POST" enctype="multipart/form-data" class="mt-8">
            @csrf
                        ...
                        <div class="admin-card-body">
                            ...
                            <div class="mb-6">
                                ...
                                <textarea name="excerpt" id="excerpt" rows="3" required
                                          class="form-textarea mt-1 @error('excerpt') border-red-500 @enderror">{{ old('excerpt') }}</textarea>
                                @error('excerpt')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="admin-card-body space-y-4">
                            ...
                            <div>
                                ...
                                <textarea name="meta_description" id="meta_description" rows="3"
                                          class="form-textarea mt-1">{{ old('meta_description') }}</textarea>
                            </div>
